// 停用
package cisco_adaptive_security_virtual_appliance
...
type CiscoASAvDetector struct {
	httpClient protocols.HTTPClient
}

func NewCiscoASAvDetector(httpClient protocols.HTTPClient, _ protocols.TCPClient, _ protocols.UDPClient) detectors.Detector {
	return &CiscoASAvDetector{httpClient: httpClient}
}

func (d *CiscoASAvDetector) Detect(ctx context.Context, cnProduct, vendor, target string) (string, error) {
	// 如果没有前缀协议，自动添加 https
